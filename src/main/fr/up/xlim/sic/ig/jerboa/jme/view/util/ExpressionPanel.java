 ...
 * @author Valentin
 *
 *         TODO: Faire une coloration sur les param�tre quand ils sont
 *         appell� : \@rule<blabla>(Parametre => valeur) il faudrait
 *         v�rifier qu'il existent dans la r�gle courante
 */
...
//		}
	...
	private void updateLineCount() {
		...
		for (int i = 1; i <= nbLine; i++) {
			// on prépare l'alignement des nombres sur la droite :
			String labContent = i + "";
...
//				undoManager.redo();
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.isControlDown()) { // le ctrl + click ouvre la règle sous le
			// curseur
