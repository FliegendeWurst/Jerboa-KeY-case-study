...
public class TestHelper {
	...
	private JMEModeler modelerDim3;

	public TestHelper() {
		verifier = new JMEVerifTopoClassic();
		modeler = new JMEModeler("test", "module", 2);
		modelerDim3 = new JMEModeler("test dim 3", "module", 3);
	}
	...
	public JMEModeler getModelerDim3() {
		return modelerDim3;
	}
	...
	public JMERuleAtomic createErrorCycleCondition() {
		JMERuleAtomic errorCycleCondition = new JMERuleAtomic(modelerDim3, "errorCycleCondition");

		JerboaOrbit orbit1 = new JerboaOrbit(1);
		...
		leftErrorCycleCondition.creatArc(ln0, ln1, 3);
		leftErrorCycleCondition.creatArc(ln0, ln2, 0);

		for (JMENode node : leftErrorCycleCondition.getNodes()) {
			node.setOrbit(orbit1);
		}
		...
		rightErrorCycleCondition.creatArc(rn0, rn1, 3);
		rightErrorCycleCondition.creatLoop(rn0, 0);
		rightErrorCycleCondition.creatLoop(rn2, 0);

		for (JMENode node : rightErrorCycleCondition.getNodes()) {
			node.setOrbit(orbit1);
		}

		return errorCycleCondition;
	}
}
